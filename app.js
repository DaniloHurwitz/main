...
const DICT = {
  es: {
    ...
    'hero-h1-raw': 'Contenido que <em>convierte</em><br>en tres idiomas.',
    'hero-sub': 'Editor de video & especialista en contenido digital trilingüe. Reels virales, ads comerciales y subtitulación de precisión para marcas internacionales — incluyendo clientes Fortune 500 vía ICUC.',
  ...
  en: {
    ...
    'hero-h1-raw': 'Content that <em>converts</em><br>in three languages.',
    'hero-sub': 'Video editor & trilingual digital content specialist. Viral Reels, commercial ads, and precision subtitling for international brands — including Fortune 500 clients via ICUC.',
  ...
  he: {
    ...
    'hero-h1-raw': 'תוכן ש<em>ממיר</em><br>בשלוש שפות.',
    'hero-sub': 'עורך וידאו ומומחה תוכן דיגיטלי תלת־לשוני. Reels ויראליים, פרסומות ותרגום מדויק למותגים בינלאומיים — כולל לקוחות Fortune 500 דרך ICUC.',
