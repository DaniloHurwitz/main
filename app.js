...
const DICT = {
  es: {
    ...
    'nav-portfolio': 'Resultados',
    'impact-label': '02 · Impacto',
    'impact-title': 'Los números hablan solos.',
    'impact-sub': 'Métricas reales de proyectos con clientes internacionales.',
    'imp-engagement': 'Incremento promedio en engagement',
    'imp-retention': 'Retención promedio de audiencia',
    'imp-ontime': 'Proyectos entregados a tiempo',
    'imp-repeat': 'Clientes que vuelven a contratarme',
    'imp-bench': 'vs 42% promedio de la industria',
    'imp-total': 'Proyectos',
    'imp-leg-video': 'Edición de video',
    'imp-leg-subs': 'Subtitulado / Localización',
    'imp-leg-trans': 'Traducción / Copywriting',
    'nav-book': 'Libro',
    ...
    'proc-label': 'Proceso',
    'proc-title': 'De tu idea a contenido listo en 4 pasos.',
    'proc-s1-title': 'Brief rápido',
    'proc-s1-desc': 'Me mandás un WhatsApp con lo que necesitás. Sin formularios eternos.',
    'proc-s2-title': 'Propuesta en <4h',
    'proc-s2-desc': 'Te paso presupuesto, timeline y alcance. Sin letra chica.',
    'proc-s3-title': 'Primera versión',
    'proc-s3-desc': 'Entrega en 24 a 72h según el proyecto. Comunicación directa mientras trabajo.',
    'proc-s4-title': 'Ajustes finales',
    'proc-s4-desc': 'Revisiones incluidas hasta que quede perfecto. Entrega en todos los formatos.',
    'about-label': 'Sobre mí',
    'about-title': 'Danilo Hurwitz',
    'about-p1': 'Estudiante de medicina en UNMdP y editor trilingüe (hebreo, inglés, español). Empecé freelanceando entre clases y hoy trabajo con marcas globales.',
    'about-p2': 'Top Rated en Upwork con 95% Job Success Score. Trabajo directo con ICUC (moderación para Fortune 500) y ElevenLabs. Desde Mar del Plata para el mundo.',
    ...
    'hero-eyebrow': 'Solo 3 cupos este mes · HE / EN / ES',
    'hero-h1-raw': 'Contenido que no parece barato.',
    'hero-sub': 'Reels, ads y subtitulación para marcas globales. +95% Job Success en Upwork, clientes Fortune 500 vía ICUC y proyectos con ElevenLabs.',
    ...
    'calc-trust': 'Estimado orientativo. Propuesta exacta en menos de 4 horas.',
    'book-proof-1': '7 días de garantía',
    'book-proof-2': 'Soporte por WhatsApp',
    'test-title': '100% cinco estrellas. Verificado en Upwork.',
    'final-alt': 'O escribime a',
    'final-title': 'Los cupos de este mes se agotan rápido.',
    'stat-rating-label': 'Rating Upwork',
    'stat-langs-label': 'Nativo',
    'mobile-cta': 'Escribime ahora',
  ...
  en: {
    ...
    'nav-portfolio': 'Results',
    'impact-label': '02 · Impact',
    'impact-title': 'Numbers speak for themselves.',
    'impact-sub': 'Real metrics from international client projects.',
    'imp-engagement': 'Average engagement increase',
    'imp-retention': 'Average audience retention',
    'imp-ontime': 'Projects delivered on time',
    'imp-repeat': 'Clients who hire me again',
    'imp-bench': 'vs 42% industry average',
    'imp-total': 'Projects',
    'imp-leg-video': 'Video editing',
    'imp-leg-subs': 'Subtitling / Localization',
    'imp-leg-trans': 'Translation / Copywriting',
    'nav-book': 'Book',
    ...
    'nav-contact': 'Contact',
    'proc-label': 'Process',
    'proc-title': 'From your idea to ready content in 4 steps.',
    'proc-s1-title': 'Quick brief',
    'proc-s1-desc': 'Send me a WhatsApp with what you need. No forms.',
    'proc-s2-title': 'Proposal in <4h',
    'proc-s2-desc': 'Budget, timeline and scope. No fine print.',
    'proc-s3-title': 'First version',
    'proc-s3-desc': 'Delivery in 24 to 72h depending on the project. Direct comms.',
    'proc-s4-title': 'Final tweaks',
    'proc-s4-desc': 'Revisions included until it is perfect. All formats delivered.',
    'about-label': 'About me',
    'about-title': 'Danilo Hurwitz',
    'about-p1': 'Medical student at UNMdP and trilingual editor (Hebrew, English, Spanish). Started freelancing between classes, now working with global brands.',
    'about-p2': 'Top Rated on Upwork with 95% Job Success Score. Direct work with ICUC (moderation for Fortune 500) and ElevenLabs. From Mar del Plata to the world.',
    'nav-cta-text': 'Hire me',
    'nav-logo-role': 'Content Specialist',
    'banner-strong': 'Top Rated on Upwork',
    'banner-text': '95% Job Success Score · $6K+ earned · Trilingual HE/EN/ES',
    'hero-eyebrow': 'Only 3 spots this month · HE / EN / ES',
    'hero-h1-raw': 'Content that feels expensive.',
    'hero-sub': 'Reels, ads and subtitling for global brands. +95% Job Success on Upwork, Fortune 500 clients via ICUC and projects with ElevenLabs.',
    ...
    'calc-trust': 'Approximate estimate. Exact proposal in under 4 hours.',
    'book-proof-1': '7-day money back',
    'book-proof-2': 'Direct WhatsApp support',
    'test-title': '100% five stars. Verified on Upwork.',
    'final-alt': 'Or email me at',
    'final-title': 'This month spots fill up fast.',
    'stat-rating-label': 'Upwork Rating',
    'stat-langs-label': 'Native',
    'mobile-cta': 'Message me now',
  ...
  he: {
    ...
    'nav-portfolio': 'תוצאות',
    'impact-label': '02 · השפעה',
    'impact-title': 'המספרים מדברים.',
    'impact-sub': 'מדדים אמיתיים מפרויקטים בינלאומיים.',
    'imp-engagement': 'עלייה ממוצעת במעורבות',
    'imp-retention': 'שימור קהל ממוצע',
    'imp-ontime': 'פרויקטים שהועברו בזמן',
    'imp-repeat': 'לקוחות שחוזרים',
    'imp-bench': 'מול 42% ממוצע בתעשייה',
    'imp-total': 'פרויקטים',
    'imp-leg-video': 'עריכת וידאו',
    'imp-leg-subs': 'כתוביות / לוקליזציה',
    'imp-leg-trans': 'תרגום / קופירייטינג',
    'nav-book': 'ספר',
    'nav-mentoria': 'הדרכה',
    'nav-calc': 'הצעת מחיר',
    'nav-results': 'תוצאות',
    'nav-contact': 'צור קשר',
    'proc-label': 'תהליך',
    'proc-title': 'מהרעיון שלך לתוכן מוכן ב-4 צעדים.',
    'proc-s1-title': 'בריף מהיר',
    'proc-s1-desc': 'שלח לי הודעה עם מה שאתה צריך. בלי טפסים.',
    'proc-s2-title': 'הצעה ב-4 שעות',
    'proc-s2-desc': 'תקציב, לוח זמנים והיקף. בלי אותיות קטנות.',
    'proc-s3-title': 'גרסה ראשונה',
    'proc-s3-desc': 'אספקה ב-24 עד 72 שעות. תקשורת ישירה.',
    'proc-s4-title': 'התאמות אחרונות',
    'proc-s4-desc': 'תיקונים כלולים עד שזה מושלם. כל הפורמטים.',
    'about-label': 'עליי',
    'about-title': 'דנילו הורביץ',
    'about-p1': 'סטודנט לרפואה ב-UNMdP ועורך תלת-לשוני (עברית, אנגלית, ספרדית). התחלתי לעבוד כפרילנסר בין שיעורים, היום עובד עם מותגים גלובליים.',
    'about-p2': 'Top Rated ב-Upwork עם 95% ציון הצלחה. עבודה ישירה עם ICUC ו-ElevenLabs. ממר דל פלטה לעולם.',
    ...
    'hero-eyebrow': 'רק 3 מקומות החודש · HE / EN / ES',
    'hero-h1-raw': 'תוכן שלא נראה זול.',
    'hero-sub': 'סרטונים, פרסומות ותרגום למותגים גלובליים. +95% הצלחה ב-Upwork, לקוחות Fortune 500 דרך ICUC ופרויקטים עם ElevenLabs.',
    ...
    'calc-trust': 'אומדן משוער. הצעה מדויקת תוך פחות מ-4 שעות.',
    'book-proof-1': '7 ימי אחריות',
    'book-proof-2': 'תמיכה בוואטסאפ',
    'test-title': '100% חמישה כוכבים. מאומת ב-Upwork.',
    'final-alt': 'או שלח מייל ל',
    'final-title': 'המקומות החודש מתמלאים מהר.',
    'stat-rating-label': 'דירוג Upwork',
    'stat-langs-label': 'שפת אם',
    'mobile-cta': 'כתוב לי עכשיו',
...
function langsMultiplier(langs) {
  ...
  if (n === 3) return 1.7; // Bundle trilingüe: descuento 10%
  return 1 + (n - 1) * 0.4;
}
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // Video lazy loading: only play videos when visible
  const videoObserver = new IntersectionObserver((entries) => {
    entries.forEach(entry => {
      const video = entry.target;
      if (entry.isIntersecting) {
        // Only autoplay service/course videos, not portfolio (those are hover-play)
        if (!video.closest('.port-video')) {
          video.play().catch(() => {});
        }
      } else {
        video.pause();
  ...
  document.querySelectorAll('.service-media video, .res-course-visual video, .port-video video').forEach(v => {
    if (!v.closest('.port-video')) v.pause();
    videoObserver.observe(v);
  });

  // Portfolio: hover play / leave pause
  ...
  if (menuBtn) {
    const origClick = menuBtn.onclick;
    ...
    window.addEventListener('scroll', () => {
      if (!ticking) {
        requestAnimationFrame(() => {
          const heroEnd = document.querySelector('.hero')?.offsetHeight || 600;
  ...
  // ─── IMPACT SECTION: animated counters, bars, donut ───
  const impactObserver = new IntersectionObserver((entries) => {
    entries.forEach(entry => {
      ...
      // Animate counter
      const counter = entry.target.querySelector('.impact-counter');
      if (counter) {
      ...
      // Animate bar
      const bar = entry.target.querySelector('.impact-bar');
      if (bar) {
        const w = bar.dataset.width;
        entry.target.style.setProperty('--bar-width', w);
      }
    });
  }, { threshold: 0.3 });

  document.querySelectorAll('.impact-card:not(.impact-card-wide)').forEach(card => {
    impactObserver.observe(card);
  });

  // Donut chart animation
  const donutCard = document.querySelector('.impact-card-wide');
  if (donutCard) {
    const donutObserver = new IntersectionObserver((entries) => {
      entries.forEach(entry => {
        ...
        entry.target.querySelectorAll('.donut-seg').forEach(seg => {
    ...
    donutObserver.observe(donutCard);
  }
